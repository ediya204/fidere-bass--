...
const MOCK_ID = 'demo-id';
const MOCK_TITLE = 'demo-post';
...
export const paths = {
  ...
  dashboard: {
    ...
    baas: {
      root: `${ROOTS.DASHBOARD}/baas`,
      entities: `${ROOTS.DASHBOARD}/baas/entities`,
      accounts: `${ROOTS.DASHBOARD}/baas/accounts`,
      accountDetails: (id: string) => `${ROOTS.DASHBOARD}/baas/accounts/${id}`,
      virtualAccounts: `${ROOTS.DASHBOARD}/baas/virtual-accounts`,
    ...
    post: {
      ...
      demo: {
        details: `${ROOTS.DASHBOARD}/post/${MOCK_TITLE}`,
        edit: `${ROOTS.DASHBOARD}/post/${MOCK_TITLE}/edit`,
      },
    },
    order: {
